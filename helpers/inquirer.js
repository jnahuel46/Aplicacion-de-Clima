...
const listarLugares = async (lugares = []) => {
    ...
    const choices = lugares.map((lugar, i) => { //Aca listo las opciones
    ...
    choices.unshift({                       //Sumo al principio con el unshift la opcion cancelar
        value: '0',
    ...
    const { id } = await inquirer.prompt(preguntas); // una vez que seleccione la opcion en consola la envio con el return
    return id;
};
